...
def profile_areashape(args: Namespace, logger: Logger, paths: dict, benchmarks: dict) -> None:
    ...
    out_dir = os.path.join(paths["data_staged"], "areashape.csv")
